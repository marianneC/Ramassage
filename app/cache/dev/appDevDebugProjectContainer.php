...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \CCI\RamScoBundle\Form\ProfileType A CCI\RamScoBundle\Form\ProfileType instance.
     */
    protected function getApp_Form_ProfileService()
    {
        return $this->services['app.form.profile'] = new \CCI\RamScoBundle\Form\ProfileType();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \CCI\RamScoBundle\Form\RegistrationType A CCI\RamScoBundle\Form\RegistrationType instance.
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \CCI\RamScoBundle\Form\RegistrationType();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ramsco', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\CCI\\RamScoBundle\\Entity'))), 'CCI\\RamScoBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('CCIRamScoBundle' => 'CCI\\RamScoBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a31b84cee80412e771fc744538077164e88359246da47bedc80c74ccb42637fa');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('CCI\\RamScoBundle\\Entity\\Personne');
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'CCI\\RamScoBundle\\Form\\ProfileType', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('CCI\\RamScoBundle\\Entity\\Personne');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'CCI\\RamScoBundle\\Form\\RegistrationType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('CCI\\RamScoBundle\\Entity\\Personne');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('CCI\\RamScoBundle\\Entity\\Personne');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'CCI\\RamScoBundle\\Entity\\Personne');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\CCI\\RamScoBundle/Resources/views'), 'CCIRamSco');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('83459f2fc21b730513f5bca27f4125263cea08bf');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CCIRamScoBundle' => 'CCI\\RamScoBundle\\CCIRamScoBundle',
            ...
            'secret' => '83459f2fc21b730513f5bca27f4125263cea08bf',
            'locale' => 'en',
            ...
            'kernel.secret' => '83459f2fc21b730513f5bca27f4125263cea08bf',
            ...
            'fos_user.model.user.class' => 'CCI\\RamScoBundle\\Entity\\Personne',
            'fos_user.profile.form.type' => 'CCI\\RamScoBundle\\Form\\ProfileType',
            ...
            'fos_user.registration.form.type' => 'CCI\\RamScoBundle\\Form\\RegistrationType',
